...
namespace Dspx {
    ...
    //===========================================================================
    // Timeline
    class DSPXMODEL_EXPORT DspxTimelineEntity : public AceTreeEntityMapping {
        Q_OBJECT
    public:
    ...
    //===========================================================================
    // TimeSignature List
    class DSPXMODEL_EXPORT DspxTimeSignatureListEntity
    ...
    //===========================================================================
    // Tempo
    class DSPXMODEL_EXPORT DspxTempoEntity : public AceTreeEntityMapping {
        Q_OBJECT
    ...
    //===========================================================================
    // Tempo List
    class DSPXMODEL_EXPORT DspxTempoListEntity : public AceTreeEntityRecordTable,
    ...
    //===========================================================================
    // TimelineLabel
    class DSPXMODEL_EXPORT DspxTimelineLabelEntity : public AceTreeEntityMapping {
        Q_OBJECT
        Q_PROPERTY(int position READ position WRITE setPosition NOTIFY positionChanged)
    ...
    //===========================================================================
    // TimelineLabel List
    class DSPXMODEL_EXPORT DspxTimelineLabelListEntity
        : public AceTreeEntityRecordTable,
