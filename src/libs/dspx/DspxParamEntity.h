...
namespace Dspx {
    ...
    class DSPXMODEL_EXPORT DspxParamCurveEntity : public AceTreeEntityMapping {
        Q_OBJECT
    ...
    //===========================================================================
    // ParamFree
    class DSPXMODEL_EXPORT DspxParamFreeEntity : public DspxParamCurveEntity {
        Q_OBJECT
    public:
    ...
    //===========================================================================
    // ParamFreeData
    class DSPXMODEL_EXPORT DspxParamFreeDataEntity : public AceTreeNumbersEntity, public AceTreeEntityNumbersHelper<qint16> {
        Q_OBJECT
    public:
    ...
    class DSPXMODEL_EXPORT DspxParamAnchorEntity : public DspxParamCurveEntity {
        Q_OBJECT
    public:
    ...
    //===========================================================================
    // ParamCurve List
    class DSPXMODEL_EXPORT DspxParamCurveListEntity : public AceTreeEntityRecordTable,
    ...
    class DSPXMODEL_EXPORT DspxParamInfoEntity : public AceTreeEntityMapping {
        Q_OBJECT
    ...
    class DSPXMODEL_EXPORT DspxEnvParamInfoEntity : public DspxParamInfoEntity {
        Q_OBJECT
    public:
    ...
    class DSPXMODEL_EXPORT DspxParamSetEntity : public AceTreeEntityMapping {
        Q_OBJECT
    public:
