...
namespace Dspx {
    ...
    //===========================================================================
    // ClipTime
    class DSPXMODEL_EXPORT DspxClipTimeEntity : public AceTreeEntityMapping {
        Q_OBJECT
    ...
    class DSPXMODEL_EXPORT DspxClipEntity : public AceTreeEntityMapping {
        Q_OBJECT
    ...
    //===========================================================================
    // AudioClip
    class DSPXMODEL_EXPORT DspxAudioClipEntity : public DspxClipEntity {
        Q_OBJECT
    ...
    //===========================================================================
    // SingingClip
    class DSPXMODEL_EXPORT DspxSingingClipEntity : public DspxClipEntity {
        Q_OBJECT
    public:
    ...
    //===========================================================================
    // Clip List
    class DSPXMODEL_EXPORT DspxClipListEntity : public AceTreeEntityRecordTable,
    ...
    //===========================================================================
    // Track
    class DSPXMODEL_EXPORT DspxTrackEntity : public AceTreeEntityMapping {
        Q_OBJECT
    ...
    //===========================================================================
    // Track List
    class DSPXMODEL_EXPORT DspxTrackListEntity : public AceTreeEntityVector,
